# =============================================================================
# Aurora PostgreSQL Advanced Example - Variables
# =============================================================================
...
variable "enable_postgis" {
  description = "Enable PostGIS extension for geographic data"
  type        = bool
  default     = true
}
